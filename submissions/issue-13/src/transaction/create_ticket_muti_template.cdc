...
field: String,fieldImg: String,detailAddress: String,city: String,quantity :UInt64){
   let  proxy :&TicketNFT.MinterProxy
    ...
    execute{
        ...
        let ticketNFT<-self.ownerMinter.mintMutiTicketNFT(tickeTemplateID:templateID,quantity:quantity)
