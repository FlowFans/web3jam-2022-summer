...
transaction(recipient: Address, withdrawID: UInt64) {
    ...
    let withdrawRef: &SinGirlsNFT.Collection
    ...
    prepare(signer: AuthAccount) {
        ...
        self.withdrawRef = signer.getCapability(/public/SinGirlsCollection)
            .borrow<&SinGirlsNFT.Collection>()
        ...
        self.depositRef = recipient.getCapability(/public/SinGirlsCollection)
