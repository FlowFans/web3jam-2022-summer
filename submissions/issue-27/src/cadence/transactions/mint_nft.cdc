...
transaction(
    ...
    let minter: &RelationNFT.NFTMinter
    ...
    prepare(signer: AuthAccount) {
        self.mintingIDBefore = RelationNFT.totalSupply

        // borrow a reference to the NFTMinter resource in storage
        self.minter = signer.borrow<&RelationNFT.NFTMinter>(from: RelationNFT.MinterStoragePath)
    ...
    post {
        ...
        RelationNFT.totalSupply == self.mintingIDBefore + 1: "The total supply should have been increased by 1"
    }
}
